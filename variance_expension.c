...
static __Pyx_memviewslice __pyx_f_18variance_expension_generate_var_cl_cython_sph(__Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
static PyObject *__pyx_pf_18variance_expension_generate_var_cl_cython_sph(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_cls_); /* proto */
...
static PyObject *__pyx_pw_18variance_expension_1generate_var_cl_cython_sph(PyObject *__pyx_self, PyObject *__pyx_arg_cls_); /*proto*/
static __Pyx_memviewslice __pyx_f_18variance_expension_generate_var_cl_cython_sph(__Pyx_memviewslice __pyx_v_cls_, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_L_max;
  int __pyx_v_size;
  int __pyx_v_l;
  int __pyx_v_m;
  ...
  __Pyx_RefNannySetupContext("generate_var_cl_cython_sph", 0);
 ...
 *     i = 0
 */
  __pyx_t_1 = __Pyx_MemoryView_Len(__pyx_v_cls_); 
 ...
 */
  __pyx_v_size = (__Pyx_pow_long((__pyx_v_L_max + 1), 2) - 4);
 ...
 */
  ...
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_size); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = NULL;
  ...
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_2, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 10, __pyx_L1_error)
 ...
 */
        ...
        __pyx_t_15 = -1;
        if (__pyx_t_14 < 0) {
          __pyx_t_14 += __pyx_v_cls_.shape[0];
          if (unlikely(__pyx_t_14 < 0)) __pyx_t_15 = 0;
        } else if (unlikely(__pyx_t_14 >= __pyx_v_cls_.shape[0])) __pyx_t_15 = 0;
        ...
        __pyx_t_15 = -1;
        if (__pyx_t_16 < 0) {
          __pyx_t_16 += __pyx_v_variance.shape[0];
          if (unlikely(__pyx_t_16 < 0)) __pyx_t_15 = 0;
        } else if (unlikely(__pyx_t_16 >= __pyx_v_variance.shape[0])) __pyx_t_15 = 0;
        if (unlikely(__pyx_t_15 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_15);
          __PYX_ERR(0, 14, __pyx_L1_error)
        }
        *((double *) ( /* dim=0 */ (__pyx_v_variance.data + __pyx_t_16 * __pyx_v_variance.strides[0]) )) = (*((double *) ( /* dim=0 */ (__pyx_v_cls_.data + __pyx_t_14 * __pyx_v_cls_.strides[0]) )));
 ...
 */
      /*else*/ {
        ...
        __pyx_t_15 = -1;
        if (__pyx_t_17 < 0) {
          __pyx_t_17 += __pyx_v_cls_.shape[0];
          if (unlikely(__pyx_t_17 < 0)) __pyx_t_15 = 0;
        } else if (unlikely(__pyx_t_17 >= __pyx_v_cls_.shape[0])) __pyx_t_15 = 0;
        if (unlikely(__pyx_t_15 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_15);
        ...
        __pyx_t_15 = -1;
        if (__pyx_t_18 < 0) {
          __pyx_t_18 += __pyx_v_variance.shape[0];
          if (unlikely(__pyx_t_18 < 0)) __pyx_t_15 = 0;
        } else if (unlikely(__pyx_t_18 >= __pyx_v_variance.shape[0])) __pyx_t_15 = 0;
        if (unlikely(__pyx_t_15 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_15);
          __PYX_ERR(0, 16, __pyx_L1_error)
        }
        *((double *) ( /* dim=0 */ (__pyx_v_variance.data + __pyx_t_18 * __pyx_v_variance.strides[0]) )) = ((*((double *) ( /* dim=0 */ (__pyx_v_cls_.data + __pyx_t_17 * __pyx_v_cls_.strides[0]) ))) / 2.0);
      }
      __pyx_L7:;
 ...
 */
  ...
  __Pyx_AddTraceback("variance_expension.generate_var_cl_cython_sph", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_18variance_expension_1generate_var_cl_cython_sph(PyObject *__pyx_self, PyObject *__pyx_arg_cls_); /*proto*/
static PyObject *__pyx_pw_18variance_expension_1generate_var_cl_cython_sph(PyObject *__pyx_self, PyObject *__pyx_arg_cls_) {
  __Pyx_memviewslice __pyx_v_cls_ = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("generate_var_cl_cython_sph (wrapper)", 0);
  ...
  __pyx_r = __pyx_pf_18variance_expension_generate_var_cl_cython_sph(__pyx_self, __pyx_v_cls_);
...
static PyObject *__pyx_pf_18variance_expension_generate_var_cl_cython_sph(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_cls_) {
  ...
  __pyx_t_1 = __pyx_f_18variance_expension_generate_var_cl_cython_sph(__pyx_v_cls_, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 5, __pyx_L1_error)
...
static PyMethodDef __pyx_methods[] = {
  {"generate_var_cl_cython_sph", (PyCFunction)__pyx_pw_18variance_expension_1generate_var_cl_cython_sph, METH_O, 0},
  {0, 0, 0, 0}
};
...
if (!__Pyx_RefNanny) {
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "variance_expension")) {
      if (unlikely(PyDict_SetItemString(modules, "variance_expension", __pyx_m) < 0)) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
